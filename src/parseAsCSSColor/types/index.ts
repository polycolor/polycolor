import type { CSSColorValueType as TCSSColorKeyword } from '../../utils/types/CSSColorValueType'

export type { TCSSColorKeyword }

export type TColorTuple = [number, number, number]

interface TCSSColorAdjustment {
  red?: number
  green?: number
  blue?: number
...
export interface TParseAsCSSColorFunction {
  (): null | string
